...
def dip_draw_pin(t, pin_names_2d, row, col, rectangle_width, rectangle_height):
  ...
  for i in range(row):
    ...
    for j in range(col):
      ...
      t.left(90)
      t.pendown()
      t.write(pin_names_2d[i][j], align=write_align_dip[i],
              font=('Arial', 10, 'bold'))
      t.penup()
      t.forward(pin_width * 1.5)
      t.left(90)
      ...
      t.right(90)
      t.pendown()
      t.write(str(i * col + j + 1), align=write_align_dip[int(not i)],
              font=('Arial', 10, 'bold'))
      t.penup()
      t.forward(-pin_width * 0.6)
      t.right(90)
...
def qfp_draw_pin(t, pin_names_2d, row, col, rectangle_width, rectangle_height):
  ...
  for i in range(row):
    ...
    for j in range(col):
      ...
      t.left(90)
      t.pendown()
      t.write(pin_names_2d[i][j], txt_angle = write_txt_angle_qfp[i % 2],
              align=write_align_qfp[int(i / 2)], font=('Arial', 10, 'bold'))
      t.penup()
      t.forward(pin_width * 1.5)
      t.left(90)
      t.forward(pin_width + write_offset_distance_qfp[i][0])
      ...
      t.right(90)
      t.pendown()
      t.write(str(i * col + j + 1), txt_angle = write_txt_angle_qfp[i % 2],
              align=write_align_qfp[not int(i / 2)], font=('Arial', 10, 'bold'))
      t.penup()
      t.forward(-pin_width * 0.6)
      t.right(90)
      t.forward(pin_width + write_offset_distance_qfp[i][1])
