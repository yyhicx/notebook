...
if __name__ == '__main__':
  if len(sys.argv) < 3:
    print('Usage: python3 main.py source_folder_name destination_folder_name [--ignore=<json_file_name>]')  # pylint: disable=line-too-long
    sys.exit(1)
  ...
  for root, dirs, files in os.walk(source_folder_name):
    new_root = (root if not root.startswith(source_folder_name)  # line to long
